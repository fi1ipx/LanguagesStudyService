...
-- Дамп данных таблицы langstudy.languages: ~2 rows (приблизительно)
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `midle_name` varchar(100) NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы langstudy.users: ~0 rows (приблизительно)
...
REPLACE INTO `words` (`id`, `lang_id`, `word`, `rank`, `definition`) VALUES
	(1, 1, 'prosperity', 4, 'the state of being prosperous. well-being'),
